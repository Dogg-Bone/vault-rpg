...
*You are a performer and a storyteller, a vagabond who shapes the future of the Woodland with a song or story.*
...
- flamboyant, bedraggled, masked, attractive
- fine musical instrument, flashy clothing, worn boots, colorful cape
...
### Your Nature
Choose one:
- **Legend:** Clear your exhaustion track when you put on a massive, impressive performance for a sizable audience.
- **Companion:** Clear your exhaustion track when you bolster an ally's reputation by recounting their deeds to an important audience.
...
- **Family:** ____________ and I grew up together; I know exactly how to draw them out of their shell. What do I usually have to do to make them smile?
- **Partner:** ____________ and I pulled off a spectacular heist together using my talents as a distraction. Who did we rob? What did they get, and what did I get?

### Playbook Moves
You get *Tools of the Trade*, then choose two more:

> [!tip] Tools of the Trade
> You have a symbol of your skill and talent—an instrument, a book of stories, a set of juggling pins, a puppet, etc. It has a wear track with 3 boxes. Choose 2 tags to describe your symbol:
> - Sturdy: clear 1-wear from your symbol when time passes.
> - Enchanting: when you *help or interfere* by distracting someone with your symbol, mark wear instead of exhaustion. Take +2 instead of +1.
> - Versatile: when you *trust fate* using your symbol, you can mark wear to roll with Charm instead of Luck.
> - Delicate: when you *attempt a roguish feat* using your symbol, you can mark wear to roll with Charm instead of Finesse.
> - Revealing: when you *figure out* someone while performing with your symbol, mark wear to take +1 ongoing to act on the answers to your questions.
> - Pleasant: when your band *travels*, you can mark wear to clear 2-exhaustion from everyone in the band.
>
> When you **first put on an earnest, public performance in a clearing**, roll with Charm. On a hit, name a faction you flatter; an important member comes forward to offer you work. On a 10+, mark prestige with their faction as well. On a miss, you draw the worst kind of attention to you and your friends.
...
> [!tip] Quick Fingers, Quicker Eyes
...
| :--- | :--- |
| • a clearing<br>• the forest<br>• a place far from here | • a lover, with my words<br>• a friend, with my actions<br>• an innocent, with my silence<br>• an ally, with my inaction<br>• a sibling, many times |
| **Why are you a vagabond?** | **Which faction have you served the most?** |
| • I want to see all of the Woodland<br>• I want to find a worthy hero to write about<br>• I want to witness a legendary moment firsthand<br>• I want to find the kind of true love found in epic poetry<br>• I have been run out of too many clearings to stay still | (mark two prestige for appropriate group) |
...
- If you choose "Sturdy," it only takes you a few minutes to tend to your symbol and clear 1-wear: cleaning your instrument or costume, storing a book, etc.
...
For *All Eyes on Me*, you are the center of attention as long as you keep performing. The distraction holds until you stop, someone interrupts you, or some other major event breaks the room's attention (like an explosion or a fight). You can't perform and make other moves at the same time—you're completely occupied! The +3 from spending your hold replaces the +1 ongoing for that single roll. If you miss, the audience's reaction is likely to be overwhelming, putting you in a difficult spot—you can't just shrug and walk away.
