...
### Roguish Feats
You start with these: Disable Device, Pickpocket
...
- **Partner:** _________ and I exposed a dark secret of a faction, leading to a meaningful political change. What was it? And which member of that faction hates us for it?
- **Peer:** I think _________ sees the truth of the world, and I value their perspective deeply. What kinds of information do they see that I often overlook?

### Playbook Moves
You get *The Worth of a Book*, then choose two more:

> [!tip] The Worth of a Book
...
| :--- | :--- |
| • a clearing<br>• the forest<br>• a place far from here | • my parents<br>• an older sibling<br>• an old mentor<br>• a lover or friend<br>• a formal school |
| **Why are you a vagabond?** | **Which faction have you served the most?** |
| • I want to learn all the Woodland's secrets<br>• I seek the true history of my family<br>• I want to help the Woodland<br>• I believe the current factions should be overturned<br>• I want to find a lost text or artifact | (mark two prestige for appropriate group) |
