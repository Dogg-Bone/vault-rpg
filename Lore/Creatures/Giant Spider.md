# Description
Though descriptions of the giant spiders of the woodland vary, all are linked by three touchstones: the number of appendages (eight); the number of eyes (eight, again); and a pulsing, strange abdomen swollen with all the denizens who couldn't run fast enough.
...
#### TRAITS:
- [[Monster Traits#^cdfdd4|Aggressive (Terrestrial Species)]]
- [[Monster Traits#^bf997f|Stealthy (Arboreal Species)]]
- [[Monster Traits#^d589eb|Entangling (Webs)]]
- [[Monster Traits#^d3ba3f|Terrifying]]
- [[Monster Traits#^0bb733|Venomous (Bite)]]
#### MOVES:
- Bind up a target in silken webs
