...
## Methods
Undertow Shipping operates with the subtlety of a falling tree. They believe that power is derived from control over infrastructure and the sheer mass of their presence.
...
| **12** | A massive, heavily armed war-barge belonging to Undertow Shipping drifts silently downriver, its deck entirely empty except for scorch marks and a single, ominous Corvid symbol painted in blood on the mast. |
