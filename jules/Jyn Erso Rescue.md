...
author: jules
---
# Rescue at Ironwood Mill

**Location:** Ironwood Mill, [[Swanholde]]
...
He fabricates a small, intricate metal puzzle box from scrap gears and brass casings. Reynard 'Smiles' (a known smuggler in Swanholde) owes Galen a life-debt from before the occupation. During a supervised supply run, Galen calls in the favor, slipping Reynard the box and explicitly tasking him with smuggling it out of the mill and delivering it directly to Warren the Exile.
...
A direct assault on the ground floor barracks is suicide for a single Vagabond. Warren must use Galen's advice to navigate the structure's mechanical quirks quietly.

### Room 1: The Intake Grate (Entrance / Guardian)
To avoid the heavily guarded main gates, Warren's best option is to enter through the river-level water intake. The grate is locked and heavily rusted, and the massive wooden wheel is churning violently in the river current.
* **The Hazard:** The main gear connecting the wheel to the mill is precarious. Galen's advice warned: *Do not force them or try to stall the wheel; they will slip and screech loud enough to wake the dead.*
...
* **The Escape:** Because Galen couldn't provide a direct map, Warren must find an exit on the fly. He spots a heavy iron hatch in the floor of the cell block—the refuse chute leading to the river.
